...
Q_CONSTINIT static const qt_meta_stringdata_HttpClient_t qt_meta_stringdata_HttpClient = {
    {
        ...
        QT_MOC_LITERAL(11, 13),  // "responseReady"
        QT_MOC_LITERAL(25, 0),  // ""
        QT_MOC_LITERAL(26, 4),  // "text"
        QT_MOC_LITERAL(31, 13),  // "errorOccurred"
        QT_MOC_LITERAL(45, 9)   // "errorText"
    },
    "HttpClient",
    "responseReady",
    "",
...
void HttpClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &HttpClient::responseReady; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (HttpClient::*)(const QString & );
            if (_t _q_method = &HttpClient::errorOccurred; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void HttpClient::responseReady(const QString & _t1)
{
